...
public class DesignAndOrderTacosBrowserTest {
  ...
  private void fillInAndSubmitOrderForm() {
    assertThat(browser.getCurrentUrl().startsWith(orderDetailsPageUrl())).isTrue();
  ...
  private void submitEmptyOrderForm() {
    ...
    assertThat(validationErrors.contains("Please correct the problems below and resubmit.")).isTrue();
    assertThat(validationErrors.contains("Delivery name is required")).isTrue();
    assertThat(validationErrors.contains("Street is required")).isTrue();
    assertThat(validationErrors.contains("City is required")).isTrue();
    assertThat(validationErrors.contains("State is required")).isTrue();
    assertThat(validationErrors.contains("Zip code is required")).isTrue();
    assertThat(validationErrors.contains("Not a valid credit card number")).isTrue();
    assertThat(validationErrors.contains("Must be formatted MM/YY")).isTrue();
    assertThat(validationErrors.contains("Invalid CVV")).isTrue();
  }
